...
namespace GitLabTimeManager.ViewModel
{
    ...
    {
        [UsedImplicitly] public static readonly PropertyData AllUsersProperty = RegisterProperty<UserGroupsSettingsViewModel, IReadOnlyList<string>>(x => x.AllUsers);
        [UsedImplicitly] public static readonly PropertyData GroupsProperty = RegisterProperty<UserGroupsSettingsViewModel, FastObservableDictionary<string, IList<string>>>(x => x.Groups);
        [UsedImplicitly] public static readonly PropertyData GroupsListProperty = RegisterProperty<UserGroupsSettingsViewModel, IReadOnlyList<string>>(x => x.GroupsList);
        [UsedImplicitly] public static readonly PropertyData SelectedGroupProperty = RegisterProperty<UserGroupsSettingsViewModel, string>(x => x.SelectedGroup);
        [UsedImplicitly] public static readonly PropertyData UsersProperty = RegisterProperty<UserGroupsSettingsViewModel, IReadOnlyList<string>>(x => x.Users);
        [UsedImplicitly] public static readonly PropertyData SelectedUserFromAvailableProperty = RegisterProperty<UserGroupsSettingsViewModel, string>(x => x.SelectedUserFromAvailable);
        [UsedImplicitly] public static readonly PropertyData SelectedUserProperty = RegisterProperty<UserGroupsSettingsViewModel, string>(x => x.SelectedUser);
        ...
        public UserGroupsSettingsViewModel(
            [NotNull] UsersArgument argument,
            [NotNull] IProfileService profileService,
            [NotNull] IUserProfile userProfile,
            [NotNull] INotificationMessageService messageService) : base(profileService, userProfile, messageService)
        {
    ...
    public class UsersArgument
    {
        ...
        public UsersArgument([NotNull] IReadOnlyList<string> users)
        {
