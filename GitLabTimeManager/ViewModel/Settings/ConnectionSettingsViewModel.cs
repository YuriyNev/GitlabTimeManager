...
{
    [UsedImplicitly] public static readonly IPropertyData TokenProperty = RegisterProperty<ConnectionSettingsViewModel, string>(x => x.Token);
    [UsedImplicitly] public static readonly IPropertyData UriProperty = RegisterProperty<ConnectionSettingsViewModel, string>(x => x.Uri);
