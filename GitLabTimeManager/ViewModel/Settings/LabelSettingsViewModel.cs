...
namespace GitLabTimeManager.ViewModel
{
    ...
    {
        [UsedImplicitly] public static readonly PropertyData AvailableLabelsProperty = RegisterProperty<LabelSettingsViewModel, ObservableCollection<Label>>(x => x.AvailableLabels);
        [UsedImplicitly] public static readonly PropertyData BoardLabelsProperty = RegisterProperty<LabelSettingsViewModel, ObservableCollection<Label>>(x => x.BoardLabels, () => new ObservableCollection<Label>());
        [UsedImplicitly] public static readonly PropertyData StartLabelProperty = RegisterProperty<LabelSettingsViewModel, Label>(x => x.StartLabel);
        [UsedImplicitly] public static readonly PropertyData PauseLabelProperty = RegisterProperty<LabelSettingsViewModel, Label>(x => x.PauseLabel);
        [UsedImplicitly] public static readonly PropertyData FinishLabelProperty = RegisterProperty<LabelSettingsViewModel, Label>(x => x.FinishLabel);
        [UsedImplicitly] public static readonly PropertyData PassedLabelsProperty = RegisterProperty<LabelSettingsViewModel, ObservableCollection<Label>>(x => x.PassedLabels);
