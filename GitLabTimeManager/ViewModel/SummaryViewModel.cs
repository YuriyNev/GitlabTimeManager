...
public class SummaryViewModel : ViewModelBase
{
    ...
    public static readonly PropertyData DataProperty = RegisterProperty<SummaryViewModel, GitResponse>(x => x.Data);
    public static readonly PropertyData AllSpendsForPeriodProperty = RegisterProperty<SummaryViewModel, double>(x => x.AllSpendsForPeriod);
    ...
    public ObservableCollection<StatsBlock> OnlyMonthStatsBlocks { get; } = new();
    public ObservableCollection<StatsBlock> EarlyStatsBlocks { get; } = new();
    ...
    public SummaryViewModel(ICalendar calendar,
    ...
    private static PieSeries CreatePieSeries(double value, string title, Brush? brush = null)
    {
        if (brush == null)
