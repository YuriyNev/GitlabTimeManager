...
public class MainViewModel : ViewModelBase
{
    ...
    public static readonly PropertyData ReportVmProperty = RegisterProperty<MainViewModel, ReportViewModel>(x => x.ReportVm);
    public static readonly PropertyData ErrorProperty = RegisterProperty<MainViewModel, string>(x => x.Error);
    public static readonly PropertyData LaunchIsSuccessProperty = RegisterProperty<MainViewModel, bool>(x => x.LaunchIsFinished);
    public static readonly PropertyData MessageProperty = RegisterProperty<MainViewModel, string>(x => x.Message);
    public static readonly PropertyData IsMessageOpenProperty = RegisterProperty<MainViewModel, bool>(x => x.IsMessageOpen);
    public static readonly PropertyData IsSettingsOpenProperty = RegisterProperty<MainViewModel, bool>(x => x.IsSettingsOpen);
    public static readonly PropertyData IsDefaultTabProperty = RegisterProperty<MainViewModel, bool>(x => x.IsDefaultTab);
    public static readonly PropertyData ConnectionSettingsVmProperty = RegisterProperty<MainViewModel, ConnectionSettingsViewModel>(x => x.ConnectionSettingsVm);
    public static readonly PropertyData GanttViewModelProperty = RegisterProperty<MainViewModel, GanttViewModel>(x => x.GanttViewModel);
    public static readonly PropertyData InProgressProperty = RegisterProperty<MainViewModel, bool>(x => x.InProgress);
    public static readonly PropertyData LabelSettingsVmProperty = RegisterProperty<MainViewModel, LabelSettingsViewModel>(x => x.LabelSettingsVm);
    public static readonly PropertyData UserGroupsVmProperty = RegisterProperty<MainViewModel, UserGroupsSettingsViewModel>(x => x.UserGroupsVm);
    public static readonly PropertyData LoadingStatusProperty = RegisterProperty<MainViewModel, string>(x => x.LoadingStatus);
