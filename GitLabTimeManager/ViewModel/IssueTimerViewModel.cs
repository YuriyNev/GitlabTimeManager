...
public class IssueTimerViewModel : ViewModelBase
{
    ...
    public static readonly PropertyData DescriptionProperty = RegisterProperty<IssueTimerViewModel, string>(x => x.IssueTitle);
    ...
    public static readonly PropertyData IsEditModeProperty = RegisterProperty<IssueTimerViewModel, bool>(x => x.IsEditMode);
    public static readonly PropertyData EditDescriptionProperty = RegisterProperty<IssueTimerViewModel, string>(x => x.EditedTitle);
    public static readonly PropertyData EstimateHoursProperty = RegisterProperty<IssueTimerViewModel, double>(x => x.EstimateHours);
    public static readonly PropertyData EstimateMinutesProperty = RegisterProperty<IssueTimerViewModel, double>(x => x.EstimateMinutes);
    public static readonly PropertyData EstimateSecondsProperty = RegisterProperty<IssueTimerViewModel, double>(x => x.EstimateSeconds);
