...
{
    [UsedImplicitly] public static readonly IPropertyData WrappedIssuesProperty = RegisterProperty<GanttViewModel, ObservableCollection<WrappedIssue>>(x => x.WrappedIssues);
    [UsedImplicitly] public static readonly IPropertyData FromProperty = RegisterProperty<GanttViewModel, double>(x => x.From);
    [UsedImplicitly] public static readonly IPropertyData ToProperty = RegisterProperty<GanttViewModel, double>(x => x.To);
